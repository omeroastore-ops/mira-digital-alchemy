      ...
      <div className="container-max relative z-10">
        <div className="text-center mb-20">
          <ScrollReveal stagger={true} delay={0.1}>
            ...
            <ScrollRevealItem>
              <div className="mt-8 mx-auto w-24 h-px" style={{ background: "linear-gradient(to right, transparent, var(--color-bronze), transparent)" }} />
            </ScrollRevealItem>
          </ScrollReveal>
        </div>
              ...
              <ScrollRevealItem>
                <div className="mt-12 phone-grid">
                  <div>
                    ...
                    <a href="tel:+4915775068238" className="mt-3 block font-serif text-xl text-bronze-bright hover-cream transition">+49 1577 5068238</a>
                  </div>
                  <div>
                    <div className="eyebrow">WhatsApp</div>
                    <a href="https://wa.me/4915775068238" target="_blank" rel="noreferrer" className="mt-3 block font-serif text-xl text-bronze-bright hover-cream transition">Direktnachricht</a>
                  </div>
                </div>
              </ScrollRevealItem>
              ...
              <ScrollRevealItem>
                <div className="mt-12 stat-box">
                  ...
                  <div className="space-y-2 font-serif text-lg">
                    <div className="flex justify-between"><span className="text-dim">Montag – Donnerstag</span><span>17:00 – 01:00</span></div>
                    <div className="flex justify-between"><span className="text-dim">Freitag – Samstag</span><span>15:00 – 03:00</span></div>
                    <div className="flex justify-between"><span className="text-dim">Sonntag</span><span>17:00 – 01:00</span></div>
                  </div>
                </div>
              </ScrollRevealItem>
            </ScrollReveal>
            ...
            <div className="frame-bronze location-map-container shadow-[0_30px_80px_rgba(0,0,0,0.6)]">
              {mapAllowed ? (
                ...
                <div className="location-map-wrapper">
                  ...
                  <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" className="text-bronze relative">
