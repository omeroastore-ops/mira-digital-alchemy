    ...
    <footer className="footer-wrap px-6 md-px-12">
      <div className="container-max grid-3">
        <div>
          ...
          <div className="font-display text-[0.6rem] tracking-[0.5em] text-bronze mt-2">
            HOOKAH · LOUNGE
          </div>
        ...
        <div>
          ...
          <div className="text-sm text-dim space-y-1.5 leading-relaxed">
            <div className="flex justify-between">
              <span>Mo – Do</span>
              <span className="text-cream">18:00 – 01:00</span>
            </div>
            <div className="flex justify-between">
              <span>Fr</span>
              <span className="text-cream">18:00 – 03:00</span>
            </div>
            <div className="flex justify-between">
              <span>Sa</span>
              <span className="text-cream">17:00 – 03:00</span>
            </div>
            <div className="flex justify-between">
              <span>So</span>
              <span className="text-cream">16:00 – 01:00</span>
            </div>
          </div>
        </div>
      </div>
      <div className="footer-bottom">
        ...
        <div className="flex gap-6">
          <Link to="/impressum" className="hover-bronze-bright transition">
            Impressum
          </Link>
          <Link to="/datenschutz" className="hover-bronze-bright transition">
            Datenschutz
          </Link>
          <Link to="/cookie-richtlinie" className="hover-bronze-bright transition">
            Cookie-Richtlinie
          </Link>
        </div>
      </div>
