    ...
    <header className={`nav-header ${scrolled ? "nav-header-scrolled" : ""}`}>
      <div className="container-max py-5 flex items-center justify-between">
        <Link to="/" className="group">
          <div className="font-display text-xl tracking-[0.3em] text-cream group-hover-bronze-bright transition">
            MIRAÉ
          </div>
          <div className="font-display text-[0.55rem] tracking-[0.5em] text-bronze mt-0.5">
            HOOKAH · LOUNGE
          </div>
        </Link>
        <nav className="hidden md-flex items-center gap-10 text-[0.7rem] font-display uppercase tracking-[0.32em] nav-links">
          ...
          <a href={`${import.meta.env.BASE_URL}#galerie`}>Galerie</a>
