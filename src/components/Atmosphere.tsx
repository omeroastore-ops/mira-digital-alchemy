...
export function Atmosphere() {
  ...
  return (
    <section ref={sectionRef} id="atmosphaere" className="relative py-32 px-6 md-px-12 overflow-hidden">
      ...
      <div className="container-max grid md-grid-cols-12 gap-12 md-gap-16 items-center relative z-10">
        ...
        <div className="md-col-span-7 md-order-1">
          ...
          <div className="hidden md-block atmosphere-desktop-wrapper">
            ...
            <div className="absolute font-display text-[0.55rem] tracking-[0.6em] text-bronze rotate-90 origin-left" style={{ top: "58%", left: "55%" }}>— ATMOSPHÈRE —</div>
          </div>
        </div>
            ...
            <ScrollRevealItem>
              <div className="mt-12 stats-grid stat-box">
                <div>
                  ...
                  <div className="text-[0.65rem] uppercase tracking-[0.3em] text-dim mt-2">Sorten</div>
                </div>
                <div>
                  <div className="font-display text-3xl text-bronze-bright">VIP</div>
                  <div className="text-[0.65rem] uppercase tracking-[0.3em] text-dim mt-2">Lounge</div>
                </div>
                <div>
                  <div className="font-display text-3xl text-bronze-bright">03:00</div>
                  <div className="text-[0.65rem] uppercase tracking-[0.3em] text-dim mt-2">Bis Spät</div>
                </div>
              </div>
            </ScrollRevealItem>
          </ScrollReveal>
