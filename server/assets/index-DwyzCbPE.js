...
import { u as useConsent } from "./router-DMbX-nph.js";
...
function Hero() {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "relative min-h-[100svh] flex items-center justify-center overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "relative z-10 text-center px-6 max-w-5xl", children: /* @__PURE__ */ jsxs(ScrollReveal, { stagger: true, delay: 0.2, animateOnMount: true, children: [
      /* @__PURE__ */ jsx(ScrollRevealItem, { children: /* @__PURE__ */ jsx("div", { className: "eyebrow opacity-90", children: "Seit 2020 · München" }) }),
      ...
      /* @__PURE__ */ jsx(ScrollRevealItem, { children: /* @__PURE__ */ jsx("p", { className: "hero-description", children: "Eine verborgene Welt aus warmem Bronzelicht, samtiger Stille und sorgfältig kuratiertem Rauch. Ein Abend, der bleibt." }) }),
    ...
    /* @__PURE__ */ jsx("div", { className: "hero-ornament right", children: "EST · MMXX" })
  ] });
}
...
function Atmosphere() {
  ...
  return /* @__PURE__ */ jsxs("section", { ref: sectionRef, id: "atmosphaere", className: "relative py-32 px-6 md-px-12 overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "container-max grid md-grid-cols-12 gap-12 md-gap-16 items-center relative z-10", children: [
      /* @__PURE__ */ jsxs("div", { className: "md-col-span-7 md-order-1", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "hidden md-block atmosphere-desktop-wrapper", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "absolute font-display text-[0.55rem] tracking-[0.6em] text-bronze rotate-90 origin-left", style: { top: "58%", left: "55%" }, children: "— ATMOSPHÈRE —" })
        ] })
      ] }),
  ...
  return /* @__PURE__ */ jsxs("section", { id: "karte", className: "relative py-32 px-6 md-px-12 overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "container-max relative z-10", children: [
      /* @__PURE__ */ jsx("div", { className: "text-center mb-20", children: /* @__PURE__ */ jsxs(ScrollReveal, { stagger: true, delay: 0.1, children: [
        ...
        /* @__PURE__ */ jsx(ScrollRevealItem, { children: /* @__PURE__ */ jsx("div", { className: "mt-8 mx-auto w-24 h-px", style: { background: "linear-gradient(to right, transparent, var(--color-bronze), transparent)" } }) }),
      ...
      /* @__PURE__ */ jsx("div", { className: "menu-sticky-nav -mx-6 -mx-12 px-6 md-px-12", children: /* @__PURE__ */ jsx("div", { className: "menu-sticky-wrapper", children: MENU.map((c) => /* @__PURE__ */ jsx("button", { onClick: () => scrollTo(c.id), className: `menu-tab ${active === c.id ? "active" : ""}`, children: c.title }, c.id)) }) }),
      /* @__PURE__ */ jsx("div", { className: "space-y-24", children: MENU.map((cat, idx) => /* @__PURE__ */ jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxs(ScrollReveal, { stagger: true, delay: 0.1, children: [
            /* @__PURE__ */ jsx(ScrollRevealItem, { children: /* @__PURE__ */ jsxs("div", { className: `flex items-baseline gap-6 mb-10 ${idx % 2 ? "md-flex-row-reverse md-text-right" : ""}`, children: [
              /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "hidden md-block flex-1 h-px", style: { background: "linear-gradient(to right, rgba(184,137,90,0.4), transparent)" } })
            ] }) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "container-max relative z-10", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-2 gap-12 md-gap-16 items-center", children: [
        /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs(ScrollReveal, { stagger: true, delay: 0.15, children: [
          ...
          /* @__PURE__ */ jsx(ScrollRevealItem, { children: /* @__PURE__ */ jsxs("div", { className: "mt-12 phone-grid", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("a", { href: "tel:+4915775068238", className: "mt-3 block font-serif text-xl text-bronze-bright hover-cream transition", children: "+49 1577 5068238" })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("div", { className: "eyebrow", children: "WhatsApp" }),
              /* @__PURE__ */ jsx("a", { href: "https://wa.me/4915775068238", target: "_blank", rel: "noreferrer", className: "mt-3 block font-serif text-xl text-bronze-bright hover-cream transition", children: "Direktnachricht" })
            ] })
          ] }) }),
          /* @__PURE__ */ jsx(ScrollRevealItem, { children: /* @__PURE__ */ jsxs("div", { className: "mt-12 stat-box", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-2 font-serif text-lg", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
                ...
                /* @__PURE__ */ jsx("span", { children: "17:00 – 01:00" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
                /* @__PURE__ */ jsx("span", { className: "text-dim", children: "Freitag – Samstag" }),
                /* @__PURE__ */ jsx("span", { children: "15:00 – 03:00" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
        ...
        /* @__PURE__ */ jsx(ScrollReveal, { delay: 0.3, children: /* @__PURE__ */ jsx("div", { className: "frame-bronze location-map-container shadow-[0_30px_80px_rgba(0,0,0,0.6)]", children: mapAllowed ? /* @__PURE__ */ jsx(
          ...
          /* @__PURE__ */ jsxs("svg", { width: "48", height: "48", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1", className: "text-bronze relative", children: [
          ...
          /* @__PURE__ */ jsx(Magnetic, { children: /* @__PURE__ */ jsx("button", { onClick: () => setConsent("accepted"), className: "btn-bronze mt-8 relative", style: { padding: "0.8rem 1.6rem" }, children: /* @__PURE__ */ jsx("span", { children: "Cookies akzeptieren" }) }) })
        ] }) }) })
      ] })
    ] })
  ] });
