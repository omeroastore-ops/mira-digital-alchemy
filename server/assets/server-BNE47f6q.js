...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-IylpMUnV.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DMbX-nph.js").then((n) => n.r),
    import("./start-CmmqmDHd.js"),
...
var ROUTER_BASEPATH = "mira-digital-alchemy";
var SERVER_FN_BASE = "/mira-digital-alchemy/_serverFn/";
