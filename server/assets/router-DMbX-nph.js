...
const appCss = "/mira-digital-alchemy/assets/styles-BgkiwiPc.css";
function Nav() {
  ...
  return /* @__PURE__ */ jsx("header", { className: `nav-header ${scrolled ? "nav-header-scrolled" : ""}`, children: /* @__PURE__ */ jsxs("div", { className: "container-max py-5 flex items-center justify-between", children: [
    ...
    /* @__PURE__ */ jsx("a", { href: "tel:+4915775068238", className: "hidden md-inline text-[0.7rem] font-display uppercase tracking-[0.3em] text-bronze-bright hover-cream transition", children: "+49 1577 506 8238" })
  ] }) });
}
function Footer() {
    ...
    /* @__PURE__ */ jsxs("div", { className: "container-max grid-3", children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "text-sm text-dim space-y-2 leading-relaxed", children: [
          ...
          /* @__PURE__ */ jsx("a", { href: "tel:+4915775068238", className: "block mt-3 text-bronze-bright hover-cream transition", children: "+49 1577 5068238" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex gap-4 mt-6", children: [
          /* @__PURE__ */ jsx("a", { href: "https://instagram.com", target: "_blank", rel: "noreferrer", "aria-label": "Instagram", className: "social-link", children: /* @__PURE__ */ jsxs("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.5", className: "text-bronze-bright", children: [
            /* @__PURE__ */ jsx("rect", { x: "3", y: "3", width: "18", height: "18", rx: "5" }),
            /* @__PURE__ */ jsx("circle", { cx: "12", cy: "12", r: "4" }),
            /* @__PURE__ */ jsx("circle", { cx: "17.5", cy: "6.5", r: "0.5", fill: "currentColor" })
          ] }) }),
          /* @__PURE__ */ jsx("a", { href: "https://wa.me/4915775068238", target: "_blank", rel: "noreferrer", "aria-label": "WhatsApp", className: "social-link", children: /* @__PURE__ */ jsx("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "currentColor", className: "text-bronze-bright", children: /* @__PURE__ */ jsx("path", { d: "M17.5 14.4c-.3-.1-1.7-.8-2-.9-.3-.1-.5-.1-.7.1-.2.3-.7.9-.9 1.1-.2.2-.3.2-.6.1-.3-.1-1.2-.4-2.3-1.4-.9-.8-1.4-1.7-1.6-2-.2-.3 0-.5.1-.6.1-.1.3-.3.4-.5.1-.2.2-.3.3-.5.1-.2 0-.4 0-.5 0-.1-.7-1.6-.9-2.2-.2-.6-.5-.5-.7-.5h-.5c-.2 0-.5.1-.7.3-.2.3-.9.9-.9 2.2 0 1.3.9 2.5 1 2.7.1.2 1.8 2.8 4.4 3.9.6.3 1.1.4 1.5.5.6.2 1.2.2 1.6.1.5-.1 1.5-.6 1.7-1.2.2-.6.2-1.1.1-1.2-.1-.1-.3-.2-.5-.3zM12 2C6.5 2 2 6.5 2 12c0 1.8.5 3.5 1.3 5L2 22l5.2-1.4c1.4.8 3 1.2 4.7 1.2 5.5 0 10-4.5 10-10S17.5 2 12 2zm0 18.2c-1.5 0-3-.4-4.3-1.2l-.3-.2-3.1.8.8-3-.2-.3c-.8-1.3-1.3-2.9-1.3-4.5C3.6 7.4 7.4 3.6 12 3.6c4.6 0 8.4 3.8 8.4 8.4s-3.8 8.2-8.4 8.2z" }) }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "text-sm text-dim space-y-1.5 leading-relaxed", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-cream", children: "17:00 – 01:00" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsx("span", { children: "Fr – Sa" }),
            /* @__PURE__ */ jsx("span", { className: "text-cream", children: "15:00 – 03:00" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
...
function CookieBanner() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "cookie-banner-wrap", children: /* @__PURE__ */ jsxs("div", { className: "cookie-banner-content", children: [
    /* @__PURE__ */ jsxs("div", { className: "text-sm leading-relaxed text-dim max-w-2xl", children: [
      ...
      " ",
      /* @__PURE__ */ jsx(Link, { to: "/cookie-richtlinie", className: "underline underline-offset-4 hover-bronze-bright", children: "Mehr erfahren" })
    ] }),
...
const Route$4 = createRootRouteWithContext()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;0,600;0,700;1,400&family=Cinzel:wght@400;500;600;700&family=Inter:wght@300;400;500;600&display=swap" },
...
const $$splitComponentImporter$3 = () => import("./impressum-BdMAUgoI.js");
...
const $$splitComponentImporter$2 = () => import("./datenschutz-C35qpJ6O.js");
...
const $$splitComponentImporter$1 = () => import("./cookie-richtlinie-BFQzxPe_.js");
...
const $$splitComponentImporter = () => import("./index-DwyzCbPE.js");
